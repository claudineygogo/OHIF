...
class OptimizerApp:
    def __init__(self, root):
        ...
        self.do_decimate = tk.BooleanVar(value=True)
    ...
    def run_optimization(self):
        ...
        output_path = os.path.join(base_parent, f"Optimized_{suffix}")
        ...
        try:
            ...
            save_refined_datasets(images, structs, output_path, prefix=f"[{suffix}]", log_func=self.log)
            self.log("DONE! You can find the files in the output folder.")
