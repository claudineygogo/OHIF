...
class AssessmentUI {
    ...
    updateUIWithConfig() {
        ...
        document.getElementById("text-instructions-header").textContent = this.config.text.instructions_header;
    ...
    startAssessment() {
        ...
        if (viewerFrame) {
            ...
            console.log(`Bridge: Loading viewer with URL: ${this.caseUrl}`);
            viewerFrame.src = this.caseUrl;
        }
